...
const SearchContent = (props) => {
  ...
  const getSearchMovies = async (searchItem) => {
    const movieUrl = `search/movie?api_key=334a51625e2d99a2cb4f30205a19b196&language=en-US&query=${searchItem}&page=1&include_adult=false`;
    const tvUrl = `search/tv?api_key=334a51625e2d99a2cb4f30205a19b196&language=en-US&page=1&query=${searchItem}&include_adult=false`;
  ...
  return !videoInfoError && !searchedError ? (
    <div className="SearchContent">
      <div className="SearchGrid">{movieCards}</div>
