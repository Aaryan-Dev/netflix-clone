...
const fetchTvGenres = async () => {
  try {
    const response = await axios.get(
      `genre/tv/list?api_key=334a51625e2d99a2cb4f30205a19b196&language=en-US`
    );
...
export const fetchTvShowsByGenres = createAsyncThunk(
  "tvByGenreSlice/fetchTvShowsByGenres",
