...
export const fetchNetflixOriginals = createAsyncThunk(
  "netflixOriginalsSlice/fetchNetflixOriginals",
  async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get(
        `discover/tv?api_key=334a51625e2d99a2cb4f30205a19b196&language=en-US&sort_by=popularity.desc&page=1&timezone=America%2FNew_York&with_networks=213&include_null_first_air_dates=false`
      );
