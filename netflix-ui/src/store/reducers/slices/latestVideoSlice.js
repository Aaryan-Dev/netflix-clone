  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await Promise.all([
        axios
          .get(
            `discover/movie?api_key=334a51625e2d99a2cb4f30205a19b196&language=en-US&sort_by=primary_release_date.desc&include_adult=false&include_video=false&page=1&vote_average.gte=6`
          )
          .then((response) => ({
            title: "Latest Movies",
        ...
        axios
          .get(
            `discover/tv?api_key=334a51625e2d99a2cb4f30205a19b196&language=en-US&sort_by=first_air_date.desc&page=1&timezone=America%2FNew_York&vote_average.gte=6&include_null_first_air_dates=false`
          )
          .then((response) => ({
